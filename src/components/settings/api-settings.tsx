    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage your API keys and integration settings for justplay.
          </CardDescription>
        </CardHeader>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Create and manage API keys for accessing justplay
                programmatically.
              </CardDescription>
            </div>
                  ...
                  <div className="flex-1 relative">
                    <Input
                      value={
                        showApiKey
                          ? apiKey.key
                          : "sk_" + "•".repeat(apiKey.key.length - 3)
                      }
                      readOnly
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                id="webhook-url"
                placeholder="https://your-app.com/webhooks/justplay"
                className="flex-1"
              />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Learn how to integrate justplay into your applications.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
