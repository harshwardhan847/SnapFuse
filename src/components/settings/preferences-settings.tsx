                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="1024x768">
                        1024x768 (Landscape)
                      </SelectItem>
                      <SelectItem value="768x1024">
                        768x1024 (Portrait)
                      </SelectItem>
                    </SelectContent>
                  </Select>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Higher values produce more creative but less predictable
                  results.
                </FormDescription>
                <FormMessage />
              </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Add justplay watermark to generated content.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
