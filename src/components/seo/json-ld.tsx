...
export function JsonLd() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What is justplay?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "justplay is an AI-powered platform for generating high-quality images and videos using advanced artificial intelligence technology.",
        },
      },
      {
        "@type": "Question",
