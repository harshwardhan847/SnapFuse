...
export function TopupCard({ topup, onPurchase, disabled }: TopupCardProps) {
  ...
  return (
    <Card
      className={`relative ${topup.popular ? "border-primary shadow-md" : ""}`}
    >
      {topup.popular && (
      ...
      <CardHeader className="text-center">
        ...
        <CardDescription>${pricePerCredit} per credit</CardDescription>
        <div className="mt-2">
      ...
      <CardContent className="text-center">
        ...
        <div className="text-sm text-muted-foreground mt-1">
          Generate {topup.credits} images or {Math.floor(topup.credits / 5)}{" "}
          videos
        </div>
      </CardContent>
