...
const useCases = [
  {
    ...
    description: "Social media, ads, promotional content",
  },
  {
    id: "ecommerce",
    label: "E-commerce",
    description: "Product images, listings, catalogs",
  },
  {
    id: "content_creation",
    label: "Content Creation",
    description: "Blog posts, articles, creative content",
  },
  {
    id: "education",
    label: "Education & Training",
    description: "Educational materials, presentations",
  },
  {
    id: "personal",
    label: "Personal Projects",
    description: "Hobby projects, personal use",
  },
  {
    id: "business",
    label: "Business Communications",
    description: "Reports, presentations, documentation",
  },
];
...
const experienceLevels = [
  {
    id: "beginner",
    label: "Beginner",
    description: "New to AI content generation",
  },
  {
    id: "intermediate",
    label: "Intermediate",
  ...
  },
  {
    id: "advanced",
    label: "Advanced",
    description: "Experienced with AI and content creation",
  },
];
...
const contentTypes = [
  ...
  {
    id: "both",
    label: "Both Images & Videos",
    description: "Mixed content creation",
  },
];
...
const qualityPreferences = [
  {
    id: "speed",
    label: "Speed",
    description: "Faster generation, standard quality",
  },
  {
    id: "balanced",
    label: "Balanced",
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Help us understand how you plan to use justplay.
        </p>
      </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                What's your main reason for using justplay?
              </FormDescription>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>What's more important to you?</FormDescription>
              <div className="grid gap-3">
