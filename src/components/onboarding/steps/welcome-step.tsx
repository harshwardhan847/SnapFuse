  ...
  return (
    <div className="space-y-6 text-center">
      <div className="space-y-4">
        ...
        <div>
          <h2 className="text-2xl font-bold">Welcome to justplay!</h2>
          <p className="text-muted-foreground mt-2">
            Let's get you set up with the perfect AI-powered content generation
      ...
      <div className="bg-muted/50 rounded-lg p-4">
        <p className="text-sm">
          <strong>What to expect:</strong> We'll ask about your background,
          content preferences, and help you choose the perfect plan. You can
