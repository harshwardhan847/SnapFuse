        ...
        <div className="space-y-6">
            <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">
                    Start with a plan that fits your needs. You can always upgrade or downgrade later.
                </p>
            </div>
                        ...
                        <FormControl>
                            <div className="grid gap-4">
                                {Object.entries(SUBSCRIPTION_PLANS).map(([key, plan]) => (
                                    <Card
                                        key={key}
                                        className={`cursor-pointer transition-all hover:shadow-md ${selectedPlan === key.toLowerCase()
                                    ...
                                    >
                                        ...
                                        <CardContent className="space-y-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-medium">{plan.credits} credits per month</span>
                                            </div>
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• 1 credit = 1 AI image generation</li>
                    <li>• 5 credits = 1 AI video generation</li>
